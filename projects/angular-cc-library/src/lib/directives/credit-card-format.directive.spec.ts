...
describe("Directive: CreditCardFormat", () => {
  describe("general cases", () => {
    ...
    it("formats card number tick by tick", async () => {
    ...
    it("formats card number one tick", async () => {
      inputEl.nativeElement.value = "4111 1111";
      ...
      inputEl.triggerEventHandler("keypress", {
        keyCode: KEY_MAP.ONE,
        which: KEY_MAP.ONE,
      });
      fixture.detectChanges();
    ...
    it("deletes from middle of value", async () => {
    ...
    it("deletes from beginning of value", async () => {
    ...
    it("does not modify deleting from end of value", async () => {
      inputEl.nativeElement.value = "4111 1111 111";
